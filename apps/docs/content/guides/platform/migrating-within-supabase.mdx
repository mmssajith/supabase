...
The new project has the old project's Storage buckets, but the Storage objects need to be migrated manually. Migrate storage objects to the new project with the local Supabase Storage Migrator tool.
